...
// function written by Akash Sharma to add a message to the error_log file
void myMessageWriteErrorLog()
{
  _cupsMutexLock(&log_mutex);

 
    cupsFilePrintf(ErrorFile, "Sample message written by akash as part of assignment1_LF GsoC2018");
